    ...
    <div class="row">
      <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
          <form method="post" action="{{ route('tag.update', $tag->id)}}" class="form-horizontal">
            {{ csrf_field() }}
            {{ method_field('PATCH') }}
            <div class="row">
              ...
              <div class="col-sm-12">
                <div class="form-group">
                  <label class="col-sm-2 ">Tag Title</label>
                  <div class="col-sm-10">
                    <input type="text" id="title" name="title" placeholder="Enter tag" class="form-control" value="{{$tag->name}}">
                  </div>
                </div>
                <div class="hr-line-dashed"></div>
                <div class="form-group">
                  <label class="col-sm-2 ">Tag Slug</label>
                  <div class="col-sm-10">
                    <input type="text" id="slug" name="slug" placeholder="Enter tag slug" class="form-control" value="{{$tag->slug}}">
                  </div>
                </div>
                <div class="form-group">
                  <div class="col-sm-12">
                    <button class="btn btn-primary" type="submit" style="text-align: right;">Save</button>
                    <a class="btn btn-warning" href="{{route('tag.index')}}" style="text-align: right;">Back</a>
                  </div>
                </div>
              </div>
