            ...
            <div class="row">
              ...
              <div class="col-sm-12">
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" id="title" name="title" placeholder="Enter tag" class="form-control">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" id="subTitle" name="subTitle" placeholder="Enter tag slug" class="form-control">
                  </div>
                </div>
                <div class="form-group">
                  <div class="col-sm-12">
