<nav class="navbar navbar-static-top  @yield('header-bg')" role="navigation" style="margin-bottom: 0">
  ...
  <ul class="nav navbar-top-links navbar-right">
    <li>
      <span class="m-r-sm text-muted welcome-message">Welcome to Helfi Pangestu Dashboard.</span>
    </li>
    <li class="dropdown">
