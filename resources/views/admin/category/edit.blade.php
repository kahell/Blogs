            ...
            <div class="row">
              ...
              <div class="col-sm-12">
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" id="title" name="title" placeholder="Enter Category" class="form-control" value="{{$category->name}}">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" id="slug" name="slug" placeholder="Enter Category slug" class="form-control" value="{{$category->slug}}">
                  </div>
                </div>
