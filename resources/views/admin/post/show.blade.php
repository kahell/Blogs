      ...
      <div class="col-lg-12">
        <div class="ibox float-e-margins">
          <div class="ibox-title">
            <span class="label label-success pull-right"><a class="text-white" href="{{route('post.create')}}">Add New</a></span>
            <h5>Post</h5>
          </div>
                  ...
                  <tbody>
                    @foreach ($posts as $post)
                      <tr>
                        ...
                        <td>
                          <a href="{{ route('post.edit',$post->id)}}"><i class="fa fa-edit text-navy"> Edit </i></a>
