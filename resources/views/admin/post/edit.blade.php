            ...
            <div class="row">
              <div class="col-sm-8">
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" id="title" name="title" placeholder="Enter title" class="form-control" value="{{ $post->title}}">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" id="subTitle" name="subTitle" placeholder="Enter sub title" class="form-control"  value="{{ $post->subtitle}}">
                  </div>
                </div>
                <div class="hr-line-dashed"></div>
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" id="slug" name="slug" placeholder="Enter slug" class="form-control"  value="{{ $post->slug}}">
                  </div>
                </div>
              </div>
                ...
                <div class="form-group">
                  <div class="col-lg-12">
                    <div class="img-preview img-preview-sm">
                      @if ($post->image != null)
                        <img id="output" src="{!!Storage::disk('local')->url($post->image)!!}"/>
                      @else
                        <img id="output"/>
                      @endif
                    ...
                    <label title="Upload image file" for="inputImage" class="btn btn-primary">
                      ...
                      <input type="text" name="oldInputImage" id="oldInputImage" value="{{$post->image}}" class="hide">
                      Upload new image
                    </label>
                  </div>
                </div>
                ...
                <div class="form-group">
                  <div class="col-sm-12">
                    <label class="checkbox-inline i-checks">
                      <input type="checkbox" id="cbPublish" name="cbPublish"
                       @if ($post->status != null)
                         checked
                       @endif
                         >  Publish
